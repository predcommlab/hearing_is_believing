'''
Quick script to run the top-k tests over all subjects.
...
if __name__ == '__main__':
    ...
    for n_topk in np.arange(1, 20, 2):
        # loop over subjects
